    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="text-sm font-semibold text-gray-200">基本</div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2 md:col-span-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">翻訳の位置が原文と同じ場合、原文の下に翻訳が表示されるだす</p>
            </div>
        ...
        <div className="space-y-3">
          <div className="text-sm font-semibold text-gray-200">見た目</div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="mic-bg">背景色（CSS）</Label>
              <Input id="mic-bg" placeholder="transparent / rgba(...) ..." value={overlaySettings?.mic_transcript_background_color ?? 'transparent'} onChange={(e) => updateOverlaySettings({ mic_transcript_background_color: e.target.value })} />
            </div>
            <div className="space-y-2">
        ...
        <details className="rounded-md border border-gray-800/60 p-4">
          <summary className="cursor-pointer text-sm font-semibold text-gray-200 select-none">高度な設定</summary>
          <div className="mt-4 space-y-6">
            <div className="space-y-3">
              <div className="text-sm font-semibold text-gray-200">配置</div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2 md:col-span-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={(overlaySettings?.mic_transcript_v_align || '').trim() || 'bottom'} onValueChange={(value) => updateOverlaySettings({ mic_transcript_v_align: value })}>
                    <SelectTrigger className="h-10">
                      <SelectValue placeholder="縦揃えを選択" />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={whiteSpaceValue} onValueChange={(value) => updateOverlaySettings({ mic_transcript_white_space: value === '__auto__' ? '' : value })}>
                    <SelectTrigger>
                      <SelectValue placeholder="white-space を選択" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="__auto__">自動</SelectItem>
            ...
            <div className="space-y-3">
              <div className="text-sm font-semibold text-gray-200">行間</div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
            ...
            <div className="space-y-3">
              <div className="text-sm font-semibold text-gray-200">interim表示</div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">認識途中（finalになる前）を区別したいときに使うだす</p>
            </div>

            <div className="space-y-3">
              <div className="text-sm font-semibold text-gray-200">自動クリア</div>
              <div className="space-y-2">
